...
- [Luigi](https://luigi-project.io/) - a technology agnostic, open-source framework written in Svelte with out-of-the-box features like authorization and alert/modal management
